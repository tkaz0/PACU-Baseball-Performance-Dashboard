...
test("anonymous pages redirect to sign-in without revealing athletes", async ({ page }) => {
  for (const route of ["/analytics","/overview","/roster",`/athletes/${otherAthlete}`,"/admin/import","/admin/access","/imports","/testing","/testing/entry","/imports/game-stats","/game-stats","/leaderboards","/settings","/preview","/preview/import","/preview/roster","/preview/access", "/preview/athletes/SYN-001"]) {
