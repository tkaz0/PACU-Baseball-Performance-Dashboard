...
const session:FullSwingSession={date:context.date,mode:"Live at Bat",eventCount:6,pitcherCount:2,batterCount:0,players:[],samples:[],contacts:[],table:{headers:[],rows:[],rowNumbers:[]},pitches:[
