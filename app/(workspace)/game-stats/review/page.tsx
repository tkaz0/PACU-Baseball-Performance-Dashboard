...
export default async function GameReviewPage(){
 ...
 return <><PageHeading section="Coaching Tools / Competition" title="Data Review" description="Missing or conflicting game counts, grouped for quick follow-up."><Link href="/game-stats" className="btn btn-secondary">Team Game Stats</Link><Link href="/imports/game-stats" className="btn btn-secondary">Review Sheet Update</Link></PageHeading>
