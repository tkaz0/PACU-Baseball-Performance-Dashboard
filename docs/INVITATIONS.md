...
4. Choose and confirm a password of 6–128 characters. Each field has an independent Show/Hide button; both start hidden. No year, suffix or character mix is required. The existing password action updates that authenticated account, requests global session sign-out, and directs the recipient to sign in using their new password.
