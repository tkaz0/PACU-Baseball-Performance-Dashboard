...
import type { PlayerMetricCard, PlayerPerformance } from "@/lib/player-performance";
export const PHYSICALITY_PRIMARY = ["weight", "height", "grip_strength", "body_fat_pct"] as const;
