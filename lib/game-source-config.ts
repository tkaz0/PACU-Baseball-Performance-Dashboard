...
export const GAME_SOURCES: Record<GameSourceKey, ReviewedGameSource> = {
  qpa_fall_2026: { source: "qpa_fall_2026", spreadsheetId: "1z9X5flQ7s7ffBS1ygBLST6FCP9Tww3xtwTFFczjupuE", sheetId: 529725170, sheetTitle: "2026 - Fall", detailRows: Array.from({length:37},(_,i)=>i+2) },
