...
export const STAT_DEFINITIONS: Readonly<Record<string, string>> = {
  ...
  pitching_era: "Earned-run average: ER × 27 / recorded outs. Requires separately recorded earned runs and positive innings. Total runs allowed cannot be used. Less is higher-ranked.",
