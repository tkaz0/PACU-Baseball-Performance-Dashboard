...
export function ProfileTabs({ tabs, action }: { tabs: ProfileTab[]; action?: ReactNode }) {
  ...
  return <div className="min-w-0">
    <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
      <div role="tablist" aria-label="Player performance" className="profile-tab-navigation flex w-full min-w-0 flex-wrap gap-1 rounded-lg border border-[var(--line-subtle)] bg-[var(--surface-panel)] p-1 sm:w-auto">
