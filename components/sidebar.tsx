...
import { UsersRound, Upload, ShieldCheck, UserRound, ChevronRight, Settings, BarChart3, ListOrdered } from "lucide-react";
...
export function Sidebar({ roles, athleteId, isPreview = false }: { roles: Role[]; athleteId: string | null; isPreview?: boolean }) {
  ...
  const links = [
    ...
    ...(staff && (!isPreview || roles.includes("coach")) ? [{ href: "/imports", label: "Information Imports", icon: Upload }] : []),
