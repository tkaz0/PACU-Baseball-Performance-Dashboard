...
export function DashboardHome({staff,athleteId,summary,leaderboards=[]}:{staff:boolean;athleteId:string|null;summary:HomeSummary|null;leaderboards?:HomeLeaderboard[]}) {
  ...
  const latestUpdate=summary?.updates[0]?.date;
