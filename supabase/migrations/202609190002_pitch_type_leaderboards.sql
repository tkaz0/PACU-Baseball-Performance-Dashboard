-- Extend the existing minimal signed-in leaderboard projection to four reviewed pitch results.
-- No raw report access, profile percentile changes, count metrics or new account grants.
