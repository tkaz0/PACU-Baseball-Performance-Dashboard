-- Add existing total muscle observations to the authorized leaderboard projection only.
-- No observation, profile metric, account, alias or table grant is changed.
...
begin
  ...
  select * into metric from private.performance_metric_catalog where metric_key=p_metric_key and (profile_metric or metric_key='muscle_mass');
