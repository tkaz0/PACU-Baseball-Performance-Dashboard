-- Owner-confirmed weekly aggregates and Wk/Hrd counts. Preserve normal staff authorization and RLS.
insert into private.game_metric_columns(source,metric,source_column) values
 ('pitching_fall_2026','weak_contact',24),('pitching_fall_2026','hard_contact',25);
